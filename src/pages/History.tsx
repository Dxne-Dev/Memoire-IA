  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden p-8">
      ...
      <header className="relative z-10 mb-8">
        ...
        <p className="text-white/40 mt-2">Retrouvez l'historique de vos générations et de vos sessions.</p>
      </header>
        ...
        <GlassCard className="p-12 flex flex-col items-center justify-center text-center gap-5">
          ...
          <div>
            ...
            <p className="text-white/40 text-sm mt-2 max-w-sm mx-auto leading-relaxed">
              L'historique complet de vos actions avec l'IA sera bientôt disponible. 
              Vous pourrez revenir sur n'importe quel brouillon généré par Memoire IA.
            </p>
          </div>
        </GlassCard>
      </main>
