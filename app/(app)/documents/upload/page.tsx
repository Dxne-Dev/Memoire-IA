...
export default function UploadPage() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // On simule une progression car fetch ne le supporte pas nativement sans XHR
      ...
      toast.success("Document uploadé et analysé avec succès. Redirection...")
      setTimeout(() => {
        window.location.href = `/ai-analysis?docId=${result.docId}`
      }, 1500)

    } catch (error: any) {
      console.error("Upload error:", error)
      toast.error(error.message || "Une erreur est survenue lors de l'upload. Veuillez réessayer.")
      setUploading(false)
      setUploadProgress(0)
    }
  }
